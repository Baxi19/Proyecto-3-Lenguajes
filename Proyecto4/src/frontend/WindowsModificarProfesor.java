 ...
 * @author Baxi
 */
public class WindowsModificarProfesor extends javax.swing.JFrame {
    WindowsMenu wc;
    Profesor profesor;
    
    public WindowsModificarProfesor(WindowsMenu wm, Profesor p) {
        initComponents();
        ...
        jTextFieldApellidos.setText(profesor.getApellidos());
        jTextFieldCedula.setText(profesor.getCedula());
   }
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("Modificar profesor");
        ...
        if(!jTextFieldNombre.getText().isEmpty()){
            if(!jTextFieldApellidos.getText().isEmpty()){
                if(!jTextFieldCedula.getText().isEmpty()){
                    try {
                        String eliminar = "retract(" +Singleton.getInstance().buscarProfesor(profesor.getId()).getDatos()+").";
                        SingletonProlog.getInstance().consultaProlog(eliminar);
                        
                        SQLite.getInstance().modificarProfesor(profesor.getId(), jTextFieldNombre.getText(), jTextFieldApellidos.getText(), jTextFieldCedula.getText());
                        ...
                        Singleton.getInstance().buscarProfesor(profesor.getId()).setNombre(jTextFieldNombre.getText());
                        Singleton.getInstance().buscarProfesor(profesor.getId()).setApellidos(jTextFieldApellidos.getText());
                        Singleton.getInstance().buscarProfesor(profesor.getId()).setCedula(jTextFieldCedula.getText());
                        
                        SingletonProlog.getInstance().InsertarDatoEnMemoria(Singleton.getInstance().buscarProfesor(profesor.getId()).getHecho());
